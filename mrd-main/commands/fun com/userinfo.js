...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    if (!args[0]) {
      ...
      user =
        ...
        (await message.guild.members.fetch(args[0]).catch(err => {
          return message.lineReply("<a:loading:878308357319061514> Unable to find this Person");
        }));
    }
    ...
    if (user.id == "726395402181542008") {
      (":x: I won't give you details about my creator");
    }
    ...
    embed.setColor(
      user.displayHexColor === "#000000" ? "#7FFFD4" : user.displayHexColor
    );
